...
module.exports.deleteByCode = function create(code) {
...
module.exports.updateByCode = function update(code, credit) {
...
module.exports.retrieveBulk = function get_modules_performance(mod_registered, 
grade, grade_count) {
return query('CALL get_modules_performance($1, $2, $3)', [mod_registered, grade, grade_count])
.then(function (result) {
